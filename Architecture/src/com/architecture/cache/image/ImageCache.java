...
import com.architecture.cache.image.disk.DiskLruCache;
 ...
 * {@link ImageCache#get(FragmentManager, ImageCacheParams)} to get an instance of this
...
public class ImageCache {
     ...
     * {@link ImageCache#get(FragmentManager, ImageCacheParams)} to fetch an ImageCache
     * instance.
     *
    ...
    private void init(ImageCacheParams cacheParams) {
        ...
        if (mCacheParams.memoryCacheEnabled) {
            if (Config.IS_DEBUG) {
                LogcatUtils.d(TAG, "Memory cache created (size = " + mCacheParams.memCacheSize + ")");
            }
                ...
                if (mCacheParams.diskCacheEnabled && diskCacheDir != null) {
                    ...
                    if (getUsableSpace(diskCacheDir) > mCacheParams.diskCacheSize) {
                        try {
                            ...
                            if (Config.IS_DEBUG) {
                                LogcatUtils.d(TAG, "Disk cache initialized");
                            }
                        } catch (final Exception e) {
                            mCacheParams.diskCacheDir = null;
                            LogcatUtils.e(TAG, "initDiskCache - " + e);
                        }
                    }
                }
            }
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                    ...
                    LogcatUtils.e(TAG, "addBitmapToCache - " + e);
                }
            }
        }
    }
    ...
    public BitmapDrawable getBitmapFromMemCache(String data) {
        ...
        if (Config.IS_DEBUG && memValue != null) {
            LogcatUtils.d(TAG, "Memory cache hit");
        }
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                try {
                    ...
                    LogcatUtils.e(TAG, "getBitmapFromDiskCache - " + e);
                }
            }
            return bitmap;
        }
    ...
    public void clearCache() {
        if (mMemoryCache != null) {
            ...
            if (Config.IS_DEBUG) {
                LogcatUtils.d(TAG, "Memory cache cleared");
            }
        }
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                try {
                    ...
                    if (Config.IS_DEBUG) {
                        LogcatUtils.d(TAG, "Disk cache cleared");
                    }
                } catch (Exception e) {
                    LogcatUtils.e(TAG, "clearCache - " + e);
                }
                mDiskLruCache = null;
                initDiskCache();
            }
    ...
    public static class ImageCacheParams {
         ...
         * {@link ImageCache#get(FragmentManager, ImageCacheParams)} or
         * {@link ImageWorker#addImageCache(FragmentManager, ImageCacheParams)}.
    ...
    public enum CompressFormat {
        ...
        public android.graphics.Bitmap.CompressFormat getAndroidCompressFormat(String ext) {
        	if(this == AUTO) {
        		...
        		return android.graphics.Bitmap.CompressFormat.valueOf(this.toString());
        	}
        }
    }
