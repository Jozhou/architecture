...
import com.architecture.cache.image.task.AsyncTask;
...
import com.architecture.widget.imageview.graphics.MRecycleBitmapDrawable;
...
public abstract class ImageWorker {
	...
	private static final String LOCALFILE_PREFIX = "file://";
        ...
        protected BitmapDrawable doInBackground(Object... params) {
            ...
            try {
	            ...
	            if (bitmap == null && !isCancelled() && getAttachedImageView() != null
	                    && !mExitTasksEarly) {
	            	if(dataString.startsWith(LOCALFILE_PREFIX)) {
	            		File file = new File(dataString.substring(LOCALFILE_PREFIX.length()));
	            		if(file.exists()) {
	            			bitmap = ImageUtils.file2Bitmap(file.getAbsolutePath());
	            		}
	            	} else if(dataString.startsWith(File.separator)) {
